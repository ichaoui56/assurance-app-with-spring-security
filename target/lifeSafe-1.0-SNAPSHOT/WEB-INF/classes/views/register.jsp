...
<section class="container">
    <form class="form_container" action="${pageContext.request.contextPath}/auth/register" method="post">
        ...
        <div style="display: flex; gap: 10px">
            <div class="input_container">
                ...
                <input placeholder="Ilyas" title="Inpit title" name="name" type="text" class="input_field"
                       id="email_field">
            </div>
            <div class="input_container">
                ...
                <input placeholder="Chaoui" title="Inpit title" name="address" type="text" class="input_field"
                       id="email_field">
            </div>
        </div>
        <div style="display: flex; gap: 10px">
            <div class="input_container">
                ...
                <input placeholder="06********" title="Inpit title" name="phone" type="text" class="input_field"
                       id="email_field">
            </div>
            <div class="input_container">
                ...
                <input placeholder="ilyas@mail.com" title="Inpit title" name="email" type="text" class="input_field"
                       id="email_field">
            </div>
        </div>
        <div class="input_container">
            ...
            <input placeholder="**********" title="Inpit title" name="password" type="password" class="input_field"
                   id="password_field">
        </div>
        <c:if test="${not empty error}">
            <div style="color: red;">${error}</div>
